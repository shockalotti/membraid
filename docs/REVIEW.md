...
| R3-7 | scope slugs collide; `shared` overloaded | closed (§17 basename+hash slugs; `--scope`/`MEMORY_SCOPE`; `shared` excluded from default queries) |
