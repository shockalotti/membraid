...
| 7 | Wire into the stack, both machines | §14 | **done** - Claude Code, OpenCode, Grok, Crush and Pi on omarchy (Codex installed, not yet tested end to end); Hermes on the wynneclaw1 minipc. **Usable from here** |
